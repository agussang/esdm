        ...
        <div class="card card-block card-stretch card-height iq-border-box iq-border-box-1 text-primary">
            <div class="card-header">
                <div class="card-title">
                    <div class="row">
                        <div class="col-md-9">
                            <h5 class="card-label"><i class="fa fa-plus"></i> Form Edit Data Tanggal Ramadhan</h5>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="card-body">
                <form class="form" action="{{route('data-master.tanggal-ramadhan.update')}}" method="post">
				{!! csrf_field() !!}
