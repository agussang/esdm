                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($r->justifikasi_atasan==null || $r->justifikasi_atasan==0)
                                            <a href="{{URL::to('pegawai-bawahan/proses-justifikasi')}}/{{Crypt::encrypt($r->id_justifikasi)}}" class="btn btn-primary btn-sm"><i class="fas fa-pencil-ruler"></i> Proses Ajuan</a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
