        ...
        <div class="card card-block card-stretch card-height iq-border-box iq-border-box-1 text-primary">
            <div class="card-header">
                <div class="card-title">
                    <div class="row">
                        <div class="col-md-9">
                            <h5 class="card-label"><i class="las la-book"></i> Data Master Satuan</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form class="form" action="{{route('skp.master-skp.satuan.simpan')}}" method="post">
				{!! csrf_field() !!}
                <div class="row">
                    <div class="col-md-4">
                        <div class="input-group mb-4">
                            <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroup-sizing-default">Kode Satuan</span>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="input-group mb-4">
                            <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroup-sizing-default">Nama Satuan</span>
                            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        ...
                                        <a href="{{URL::to('/skp/master-skp/satuan/hapus')}}/{{Crypt::encrypt($r->id)}}" class="btn btn-danger text-white btn-xs" onclick="return confirm('Apakah anda yakin ingin menghapus data ini ? ');"><i class="fas fa-trash"></i> Hapus</a>
                                    </center>
                                </td>
                            </tr>
                            @endforeach
...
{
    var request = $.ajax ({
       url : "{{ route('skp.master-skp.satuan.edit_satuan') }}",
       data:"id="+id,
       type : "get",
       dataType: "html"
   });
...
function simpan_edit()
{
    ...
    var request = $.ajax ({
           url : "{{ route('skp.master-skp.satuan.update_satuan') }}",
           type : "post",
           dataType: "html",
           data: x
       });
...
function aktifkan(kode,value)
{
    ...
    var request = $.ajax ({
           url : "{{route('skp.master-skp.satuan.update_status')}}",
