...
<div class="row">
    <div class="col-md-12">
        <div class="card card-block card-stretch card-height iq-border-box iq-border-box-1 text-primary">
            ...
            <div class="card-body">
                <form class="form" action="{{route('data-pegawai.pelanggaran.simpan')}}" method="post"  method="post" enctype="multipart/form-data">
                {!! csrf_field() !!}
                    <div class="row">
                        <div class="col-md-5">
                        ...
                        <div class="col-md-3">
                            <div class="input-group mb-4">
                                ...
                                <input type="date" class="form-control" name="tgl_berlaku" id="tgl_berlaku" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
