        ...
        <div class="card card-block card-stretch card-height iq-border-box iq-border-box-1 text-primary">
            <div class="card-header">
                <div class="card-title">
                    <div class="row">
                        <div class="col-md-9">
                            <h5 class="card-label"><i class="fa fa-plus"></i> Tambah Data Riwayat Pangkat / Golongan</h5>
                        </div>
                        <div class="col-md-3">
        ...
        <div class="card card-block card-stretch card-height iq-border-box iq-border-box-1 text-warning">
            <div class="card-header">
                <div class="card-title">
                    <div class="row">
                        <div class="col-md-9">
                            <h5 class="card-label"><i class="fa fa-plus"></i> Form Tambah Data Riwayat Pangkat/Golongan</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="input-group mb-4">
                            ...
                            <span class="input-group-text" id="inputGroup-sizing-default">Nama Pangkat</span>
                            </div>
                            <select class="form-control" name="id_eselon" id="id_eselon" required>
                                {!!$pilihan_golongan!!}
                            </select>   
                        </div>
                    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    <div class="row">
                        <div class="col-md-9">
                            <h5 class="card-label"><i class="fa fa-plus"></i> Data Riwayat Pangkat / Golongan</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <span><i>*Nb: Data terakhir yang dimasukkan akan menjadi pangkat/golongan saat ini.</i></span>
                        <div class="table-reponsive">
