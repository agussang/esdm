        ...
        <div class="card card-block card-stretch card-height iq-border-box iq-border-box-1 text-primary">
            <div class="card-header">
                <div class="card-title">
                    <div class="row">
                        <div class="col-md-9">
                            <h5 class="card-label"><i class="fa fa-upload"></i> <span> Form Justifikasi Kehadiran Pegawai</span></h5>
                        </div>
                        <div class="col-md-3">
                            <a href="{{URL::to('pegawai-bawahan/riwayat-kehadiran')}}/{{Crypt::encrypt($dt_pegawai->id_sdm)}}" class="btn btn-danger pull-right"><i class="fas fa-backspace"></i> Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form class="form" action="{{route('pegawai.simpan-pengajuan-justifikasi')}}" method="post">
                    {!! csrf_field() !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group mb-4">
                                ...
                                <input type="number" value="{{$pengajuan_durasi}}" class="form-control" required max="{{$pengajuan_durasi}}" name="ajuan_durasi_justifikasi" id="ajuan_durasi_justifikasi">
                            </div>
                        </div>
                        @endif
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group mb-4">
                                ...
                                <textarea class="form-control" name="alasan" required id="alasan">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <button class="btn btn-primary pull-right"><i class="fa fa-upload"></i> Simpan Justifikasi</button>
                        </div>
                    </div>
                </form>
            </div>
