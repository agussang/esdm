                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="input-group mb-4">
                                ...
                                <select class="form-control" id="id_sdm" name="id_sdm" required disabled="true">
                                        {!!$pilihan_sdm!!}
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="input-group mb-4">
                                ...
                                <input type="date" class="form-control" name="tgl_awal" required value="{{$rsData->tgl_awal}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="input-group mb-4">
                                ...
                                <input type="date" class="form-control" name="tgl_akhir" required value="{{$rsData->tgl_akhir}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="custom-file">
                                ...
                                <input type="file" class="custom-file-input" id="inputGroupFile03" accept="application/pdf" name="file_surat">
                            </div>
                        </div>
                        <div class="col-md-4">
