...
<li class="{{ $induk[0]=="pegawai" ? 'active' : '' }}">
    <a href="{{URL::to('/pegawai')}}/{{Crypt::encrypt(Session::get('id_sdm'))}}"> <i class="fa fa-user"></i><span> Data Pegawai</span> </a>
</li>
<li class="{{ $induk[1]=="skp" ? 'active' : '' }}">
    <a href="{{URL::to('skp-pegawai/skp/')}}/{{Crypt::encrypt(Session::get('id_sdm'))}}">
